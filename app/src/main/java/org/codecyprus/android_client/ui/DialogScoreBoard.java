 ...
 * Time: 8:58 PM
 */
public class DialogScoreBoard extends AlertDialog
{
    private final TextView errorTextView;

    public DialogScoreBoard(final Context context)
    {
        super(context);
    ...
    public DialogScoreBoard(final Context context, final String message)
    {
        this(context);
        setMessage(message);
    }
